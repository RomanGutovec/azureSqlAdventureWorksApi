...
{
    public partial class tasksqldbContext : DbContext
    {
        public tasksqldbContext()
        {
        }

        public tasksqldbContext(DbContextOptions<tasksqldbContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=tcp:training-sql-server-raman.database.windows.net,1433;Initial Catalog=task-sql-db;Persist Security Info=False;User ID=raman;Password=7502974Hjvbr;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
